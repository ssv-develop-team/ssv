/*
 * Vendored from lap (https://github.com/gatagat/lap), BSD-2-Clause.
 * Copyright (c) 2012-2025, Tomas Kazmar.
 * See docs/specs/2026-07-14-T2-BoT-SORT算法一致性验证与修复-spec.md.
 */

#ifndef SSV_BOTSORT_LAPJV_H
#define SSV_BOTSORT_LAPJV_H
